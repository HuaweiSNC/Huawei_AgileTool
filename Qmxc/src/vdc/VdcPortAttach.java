...
public class VdcPortAttach {

    public final static String urlBody = "/vdc/routers/router/portAttachs/portAttach";
    public final static String fullUrlbody = "/vdc/routers/router?routerID=%s/portAttachs/portAttach";
    ...
    public VdcPortAttach(OpsRestCaller rest) {
        this.rest = rest;
    }
    ...
    public void parseRestful(RetRpc restfulJson) throws Exception
    {
       ...
       this.setIndexint(0);
        ...
        if(null == restfulJson)
        {
          throw new Exception(restfulJson+" error in VdcPortAttach.java");
        }
        if(200==restfulJson.getStatusCode())
        {
        	if (BodyType.APPLICATION_JSON == bodyType)
        	{
        		...
        		xmlHelper.configure(jsonObject, fullUrlbody, this, VdcPortAttach.OneBody.class);
        		
        	} else {
        		Document doc = RestUtil.getDoc(restfulJson.getContent());
        		OpsXMLHelper xmlHelper = new OpsXMLHelper();
        		xmlHelper.configure(doc.getDocumentElement(), fullUrlbody, this, VdcPortAttach.OneBody.class);
        	}
        }
        else
        {
    ...
    */
	...
	{
        VdcPortAttach newond = new VdcPortAttach(OpsServiceManager.getInstance().getDefaultOpsRestCall());
        try {
