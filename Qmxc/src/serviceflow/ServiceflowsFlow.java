...
public class ServiceflowsFlow {

    public final static String urlBody = "/serviceflows/serviceflow/flows/flow";
    public final static String fullUrlbody = "/serviceflows/serviceflow?id=%s/flows/flow";
    ...
    static {
        ...
        criterions.put("flowType", "{'data-type':'ENUM','expected-values':'ipv4;ipv6','example':'ipv6','access':'readCreate'}");        
        criterions.put("flowName", "{'data-type':'STRING','min':'1','max':'32','example':'string','access':'readCreate'}");        
    ...
    public class OneBody{
        ...
        public void setFlowType(String flowType){
           ...
           if(RestUtil.validata(getCriterion(S_FLOWTYPE), flowType))
           {
               ...
               System.out.println( "flowType validation failed, please check again");
           }
        }
        ...
        public void setFlowName(String flowName){
           ...
           if(RestUtil.validata(getCriterion(S_FLOWNAME), flowName))
           {
               ...
               System.out.println( "flowName validation failed, please check again");
           }
        }
    ...
    public ServiceflowsFlow(OpsRestCaller rest) {
        this.rest = rest;
    }
    ...
    public void parseRestful(RetRpc restfulJson) throws Exception
    {
       ...
       this.setIndexint(0);
        ...
        if(null == restfulJson)
        {
          throw new Exception(restfulJson+" error in ServiceflowsFlow.java");
        }
        if(200==restfulJson.getStatusCode())
        {
        	if (BodyType.APPLICATION_JSON == bodyType)
        	{
        		...
        		xmlHelper.configure(jsonObject, fullUrlbody, this, ServiceflowsFlow.OneBody.class);
        		
        	} else {
        		Document doc = RestUtil.getDoc(restfulJson.getContent());
        		OpsXMLHelper xmlHelper = new OpsXMLHelper();
        		xmlHelper.configure(doc.getDocumentElement(), fullUrlbody, this, ServiceflowsFlow.OneBody.class);
        	}
        }
        else
        {
    ...
    */
	...
	{
        ServiceflowsFlow newond = new ServiceflowsFlow(OpsServiceManager.getInstance().getDefaultOpsRestCall());
        try {
