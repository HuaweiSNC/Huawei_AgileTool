...
//				+"{\"qosPolicyNodes\":\"{}\"},";
		 ...
		 * 
		 */	
		public function ipcoreRequest(uri:String,onResult:Function,onFault:Function,method:String = "get",params:String = null,schemaType:String=""):void
		{
			if(projectType=="test"){
				...
				connUtil.clientQuery(uri,method,onResult,onFault,params,"application/json",schemaType);
			}
