...
public class MyHandPolicy extends OpsInterface {
     public String url = "";
     public String fullUrl = "/tnlm/tunnelPolicys/tunnelPolicy?tnlPolicyName=%s/tpNexthops/tpNexthop?nexthopIPaddr=%s/tpTunnels/tpTunnel";
     public String param="";
     
    public MyHandPolicy(IOpsRestCaller restcall){
        super(restcall);
        super.url = url;
