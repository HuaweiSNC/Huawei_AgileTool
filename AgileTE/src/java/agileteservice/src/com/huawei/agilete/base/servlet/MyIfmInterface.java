...
public class MyIfmInterface extends OpsInterface {
    ...
    private String[] analyticInterfaces(Element _interface){
        ...
        ri[4]=ifDynamicInfo.elementText("ifOperStatus");
        return ri;
    }
    
    
    public List<String[]> getAll(String type,String ifname){
        
    	String ifPhyType = "";
    	if(null!=type&&!type.equals("")){
    		ifPhyType = "="+type;
    	}
        super.url = "/ifm/interfaces/interface?ifName="+ifname+",ifPhyType"+ifPhyType+",ifDynamicInfo&ifmAm4/am4CfgAddrs/am4CfgAddr?ifIpAddr,subnetMask";
        RetRpc resultOps = super.getall();
        List<String[]> resultInterfaces = new ArrayList<String[]>();
        if(resultOps.getStatusCode() != 200|| "".equals(resultOps.getContent())){
    ...
    public List<String[]> getAll(String type){
        ...
        super.url = "/ifm/interfaces/interface?ifName,ifPhyType"+ifPhyType+",ifDynamicInfo&ifmAm4/am4CfgAddrs/am4CfgAddr?ifIpAddr,subnetMask";
        //super.url = "/ifm/interfaces/interface?ifName,ifPhyType&ifmAm4/am4CfgAddrs/am4CfgAddr?ifIpAddr,subnetMask";
        RetRpc resultOps = super.getall();
        List<String[]> resultInterfaces = new ArrayList<String[]>();
        if(resultOps.getStatusCode() != 200 || resultOps.getContent().equals("")){
            return resultInterfaces;
        }
    ...
    public  HashMap<String, String> getFlux(String[] content){
        ...
        if(null == content){
        	...
        	super.fullUrl = "/ifm/interfaces/interface?ifName=%s,ifDynamicInfo&ifStatistics?receiveByte,sendByte";
        }
