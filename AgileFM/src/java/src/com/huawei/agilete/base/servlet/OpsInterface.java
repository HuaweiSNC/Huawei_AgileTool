...
public class OpsInterface {
	...
	public RetRpc create(String[] concent){
		String u;
		u = change(concent);
		if (null != restcall)
		{
	...
	public RetRpc modify(String[] concent){
		String u;
		u = change(concent);
		if (null != restcall)
		{
	...
	public RetRpc delete(String[] concent){
		String u;
		u = change(concent);
		if(null != body && !"".equals(body)){
			u +="?"+param+"="+body;
	...
	private String change(String[] concent){
		String u="";
		String furl = fullUrl;
		if(null !=concent && concent.length != 0){
