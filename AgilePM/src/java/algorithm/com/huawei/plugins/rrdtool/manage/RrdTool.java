...
public class RrdTool {
	 ...
	 * @return
	 */
	public String update_fetchRrd(String rrdName,String rrdTime,String content){
...
//		String aa =RrdTool.getInstance().update_fetchRrd("ifmflux", String.valueOf(System.currentTimeMillis()), "38");
//		System.out.println("rrdtool="+aa);

//		String result = "";
//		String rrdName = "D:\\mrtg\\html\\my.rrd";
////		rrdName = "\""+rrdName+"\"";
		RrdTool rrdTool = new RrdTool();
		rrdTool.sGraphTime="100";
//		result = rrdTool.runRrd("rrdtool fetch "+rrdName+" "+ "AVERAGE --start "+(Calendar.getInstance().getTimeInMillis()-100000)+"  --end "+Calendar.getInstance().getTimeInMillis());
		rrdTool.graphRrd("my.rrd");
//		System.out.println(result);
