...
public class SdnService
{
	...
	public function onClientResultL3topo(e:HttpResponseEvent,data:ByteArray):void
	{
	...
	private function onClientResultTopol2(e:HttpResponseEvent,data:ByteArray):void
	{
		if(data.toString().search("<html>") != -1)
		{
	...
	private function onClientResultlldp(e:HttpResponseEvent,data:ByteArray):void
	{
		if(data.toString().search("<html>") != -1)
		{
	...
	private function onClientResultVcluster(e:HttpResponseEvent,data:ByteArray):void
	{
		if(data.toString().search("<html>") != -1)
		{
	...
	private function onClientResultVlantopo(e:HttpResponseEvent,data:ByteArray):void
	{
		if(data.toString().search("<html>") != -1)
		{
	...
	private function onClientResultVnm(e:HttpResponseEvent,data:ByteArray):void
	{
		if(data.toString().search("<html>") != -1)
		{
	 ...
	 */
	private function delNs(data:ByteArray):String
	{
		var str:String = data.toString();
