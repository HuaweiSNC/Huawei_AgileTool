package com.huawei.sdnc.controller.ipCoreController
{
	...
	public class IpCoreForPhysicsCtrl
	{
		...
		public function creationComplete(event:FlexEvent):void
		{
			...
			var flowStaticsTimer:FlowStaticsTimer = new FlowStaticsTimer;
			SdncUtil.flowStaticsTimer = flowStaticsTimer;
			var nqaTimer:NqaTimer = new NqaTimer;
			SdncUtil.nqaTimer = nqaTimer;
...
//					else if(item.caption == "路经计算"){
//						SdncUtil.app.dispatchEvent(new SdncEvt(SdncEvt.OPEN_PATH_CALCULATION,element));
//					}
...
//					}
		...
		public function onResultForClient(e:HttpResponseEvent, data1:ByteArray):void
		{
			...
			if(data==null||data==""||data.search("error")!=-1){
